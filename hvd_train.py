...
def sample_data(dataset, batch_size, image_size=4):
    ...
    dataset = torch.utils.data.distributed.DistributedSampler(
...
if __name__ == '__main__':
    ...
    g_optimizer = hvd.DistributedOptimizer(g_optimizer, named_parameters=generator.generator.named_parameters())
    ...
    if args.sched:
        ...
        # 8 GPU 1080Ti
        args.batch = {4: 65536, 8: 24576, 16: 2048, 32: 512, 64: 256, 128: 128, 256: 64, 512: 32, 1024: 32} # 11s/it 8 GPU
        # 1 GPU 1080Ti
        args.batch = {4: 8192, 8: 3072, 16: 256, 32: 64, 64: 32, 128: 16, 256: 8, 512: 4, 1024: 4} # 4.63s/it
